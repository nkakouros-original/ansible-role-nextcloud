...
For this above reasons, role releases will have names such as `14-2.7`, where `14` is the versions of Ansible that this role will intsall by default and `2.7` is the ansible version that the release will be compatible with.
